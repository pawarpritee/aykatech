...
export class CommercialComponent implements OnInit {
  ...
  project=[
   ...
   experties=[
    {'id':1,'name':'Small & Medium Businesses','description':'106 x 370W= 39,220W' ,'des':' Best Quality Inverter Up To 29.9kW Dedicated Post-Installation Support','wat':'39.2kW'},
    {'id':2,'name':'Large Corporations','description':'156 x 370W= 57,720W ','des':' Best Quality Inverter Up To 50kW Dedicated Post-Installation Support','wat':'57.7kW'},
    {'id':3,'name':'Power Guzzlers','description':'270 x 370W= 99,900W ','des':' Best Quality Inverter Up To 100kW Dedicated Post-Installation Support','wat':'99.9kW'}
